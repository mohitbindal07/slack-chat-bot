...
public class SlackAppController extends SlackAppServlet {
  ...
  /**
    ...
    public ResponseEntity<String> onReceiveSlashCommand(@RequestBody String payloadString) {
		logger.info("Inside the event api method: "+ payloadString);
		
		app.event(ReactionAddedEvent.class, (payload, ctx) -> {
			//String payloadString = body.getBodyAsString();
			  EventTypeExtractor eventTypeExtractor = (EventTypeExtractor) new EventsDispatcherImpl();
			  ...
			  return ResponseEntity.ok("This is a String");
			  ReactionAddedEvent event = body.getEvent();
