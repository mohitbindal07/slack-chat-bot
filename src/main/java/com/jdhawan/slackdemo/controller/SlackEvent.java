 ...
 * 
 * import me.ramswaroop.jbot.core.slack.Bot; import
 * me.ramswaroop.jbot.core.slack.Controller; import
 * me.ramswaroop.jbot.core.slack.EventType; import
 * me.ramswaroop.jbot.core.slack.models.Event; import
 * me.ramswaroop.jbot.core.slack.models.Message;
 * 
 * //@JBot
 * 
 ...
 * Message("Okay. Would you like me to set a reminder for you?"));
 ...
 *//**
	 ...
	 *//*
		 ...
		 * event) { if (event.getText().contains("yes")) { reply(session, event, new
		 * Message( "Great! I will remind you tomorrow before the meeting.")); } else {
		 * reply(session, event, new
		 * Message("Okay, don't forget to attend the meeting tomorrow :)")); }
